...
class Search extends Component {
  state = {
    books: [],
    q: "",
    message: "Search for books using the Google Books API"
  };
  ...
  getBooks = () => {
    API.getBooks(this.state.q)
      ...
      .catch(() => {
        toast.error("Your search could not be found under any book results");

        this.setState({
          books: [],
          message: "Your search could not be found under any book results",
          currentPage: 1
        });
      });
  };
            ...
            <div className="d-flex flex-wrap flex-row bd-highlight mb-3 justify-content-center align-items-center">
              ...
              <div className="order-sm-1 p-2 bd-highlight">
                ...
                <h2 className="heading-subtitle mx-sm-3 mb-2">
                  Search for Books you want to Read and Save them to a list
                </h2>
                <SearchForm
